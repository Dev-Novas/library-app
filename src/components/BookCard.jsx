...
//     return (
//         <div className="bg-red-500 rounded-xl shadow-2xl h-[300px] w-[250px] p-4 flex flex-col justify-between font-play-au">

//             {/* Book Image */}
//             <div className="h-[60%] flex justify-center items-center font-play-au">
//                 <img
